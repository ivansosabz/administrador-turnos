...
urlpatterns = [
    ...
    path(
        "responsables/editar/<int:pk>/",
        views.responsables_editar,
        name="responsables_editar",
    ),
    path(
        "responsables/eliminar/<int:pk>/",
        views.responsables_eliminar,
        name="responsables_eliminar",
    ),
    # ciclos
    ...
    path('ciclos/<int:ciclo_pk>/orden/crear/', views.ciclos_orden_crear, name='ciclos_orden_crear'),
